...
* [Elastic Memory Management for Cloud Data Analytics](https://homes.cs.washington.edu/~jwang/publications/elasticmem-atc.pdf). Jingjing Wang and Magdalena Balazinska. *USENIX ATC 2017*.  [(slides)](https://homes.cs.washington.edu/~jwang/publications/ElasticMem_ATC17.pdf)
...
Source code is available on [GitHub](https://github.com/jingjingwang/elastic-mem).
